    ...
    return (
        <main className='flex flex-col min-h-screen w-full font-Inter bg-[#FDFEFF]'>
            ...
            <div className='flex flex-col w-full items-center px-[28px]'>
                <div className='flex relative flex-col w-full items-start pt-[55px] pl-[43px] pb-[30px] gap-[50px] rounded-[20px] bg-background-tint bg-background1-mobile bg-no-repeat bg-cover 3xl:bg-background1-desktop lg:pt-[193px] lg:pl-[150px] lg:h-[640px]'>
                ...
                <div className='flex flex-col w-full mt-[34px] mb-[8px] '>
                    <div>
                        ...
                        <p className='font-medium text-[12px] text-[#323232] mt-[11px] mb-[13px]'>{data.pages.aboutUs.sectionOne.paragraph}</p>
                ...
                <div className='w-full mt-[82px] mb-[38px] flex flex-col gap-[63px]'>
                    <div className='relative'>
                        ...
                        <h1 className='absolute text-[#323232] text-[40px] font-bold leading-[47px] ml-[6px] w-[30px] top-[-25px]'>{data.pages.main.section.title[0]}</h1>
                        <p className='text-[#323232] text-[20px] font-regular mt-[40px]'>{data.pages.main.section.paragraph[0]}</p>
                    </div>
                    ...
                    <div className='relative'>
                        ...
                        <h1 className='absolute text-[#323232] text-[40px] font-bold leading-[47px] ml-[6px] w-[30px] top-[-25px]'>{data.pages.main.section.title[1]}</h1>
                        <p className='text-[#323232] text-[20px] font-regular mt-[40px]'>{data.pages.main.section.paragraph[1]}</p>
                    </div>
                </div>
