    ...
    <main className='flex font-Inter flex-col w-full min-h-screen px-[28px] bg-[#FDFEFF]'>
      ...
      <div className='flex flex-col w-full'>
        ...
        <div className='flex flex-col w-full items-start'>
          ...
          <h1 className='text-[24px] font-bold text-[#101828] leading-[36px]'>We’re here to help</h1>
          <p className='text-[12px] leading-[30px] text-[#475467] font-regular'>Have questions? We’re here to help.</p>
        ...
        <div className='flex w-full justify-center mt-[40px] mb-[11px]'>
          <img src={faqsimg} alt="FAQs image" />
        </div>
      ...
      <div className='flex flex-col gap-[11px] mb-[28px]'>
        <h1 className='text-[24px] font-semibold leading-[44px] text-[#f7941d]'>Frequently asked questions</h1>
        <p className='text-[14px] text-regular text-[#475467]'>Everything you need to know about the product and billing.</p>
      </div>

      <div className='flex flex-col w-full gap-[47px] mt-[30px] 3xl:gap-[24px]'>
      ...
      <div className='mt-[47px] mb-[72px] gap-[32px] items-center flex flex-col bg-[#f7941d] pt-[32px] pb-[40px] px-[32px] rounded-[16px]'>
        <div className='flex flex-col gap-[8px]'>
          <h1 className='text-[20px] text-center leading-[30px] text-[#fff] font-bold'>Still have questions?</h1>
          <p className='text-[15px] text-center font-regular text-[#f2f2f2] reg:text-[18px]'>Can’t find the answer you’re looking for? Please chat to our friendly team.</p>
        </div>
        <Link to={'/contact'}>
