...
export default function Statistics() {
  return (
    <section className='flex flex-col w-full text-center bg-[#2f2f2f] rounded-[20px] gap-4 px-4 pt-[18px] pb-[21px] lg:flex-row'>
      {data.pages.main.cards.text.map((item, index) => (
        <div 
          className='flex flex-col items-center w-full bg-[#58595B] gap-4 rounded-[20px] px-[17px] pt-[41px] pb-[35px] lg:backdrop-blur-24 lg:bg-white-15' 
          key={index}
        > 
